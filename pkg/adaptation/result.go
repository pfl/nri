...
func (r *result) adjustpodsandboxnetwork(conf []*NetworkConfiguration, plugin string) error {
	...
	r.request.networkrequest.Networkconfiguration = conf
	r.reply.networkcapabilities = conf
